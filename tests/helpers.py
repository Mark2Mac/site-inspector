...
def seed_resume_run(out_dir: Path, base_url: str) -> None:
    ...
    pages = [
        {
            ...
            "status_code": 200,
            "dom_fingerprint": "fp-home",
            "dom_fingerprint_nodes": 12,
        },
        {
            "url": f"{base_url}/dup-a.html",
            "status_code": 200,
            "dom_fingerprint": "fp-dup",
            "dom_fingerprint_nodes": 10,
        },
        {
            "url": f"{base_url}/dup-b.html",
            "status_code": 200,
            "dom_fingerprint": "fp-dup",
            "dom_fingerprint_nodes": 10,
        },
    ...
    crawl = {
        ...
        "host": "127.0.0.1",
        "method": {"sitemap_used": False, "max_pages": 10},
        "pages": pages,
        "errors": [],
    }
    ...
    posture = {
        ...
        "target_url": f"{base_url}/index.html",
        "host": "127.0.0.1",
        "http": {"url_final": f"{base_url}/index.html", "status_code": 200, "headers": {}, "history": []},
        "dns": {},
        "tls": {"protocol": None},
        "fingerprinting": {
            "tech": {},
            ...
            "robots_txt": None,
            "sitemap_xml": None,
            "html_meta": {"title": "Fixture site", "meta": {}},
            "links": {},
            "errors": [],
        },
        "environment": {},
