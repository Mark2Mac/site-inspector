...
def cmd_quality(args: argparse.Namespace) -> int:
    ...
    summary = quality_for_urls(
        urls,
        out_dir=out_dir,
        timeout_s=args.timeout,
        budget=budget,
        max_pages=args.max_pages,
        lighthouse_workers=args.lighthouse_workers,
    )
...
def build_parser() -> argparse.ArgumentParser:
    ...
    ap_crawl.add_argument("--crawl-workers", type=int, default=8, help="Concurrent workers for link discovery (default 8)")
    ...
    ap_quality.add_argument("--crawl-workers", type=int, default=8, help="Concurrent crawl workers (default 8)")
    ap_quality.add_argument("--lighthouse-workers", type=int, default=2, help="Concurrent Lighthouse workers (default 2)")
    ...
    ap_pw.add_argument("--crawl-workers", type=int, default=8, help="Concurrent crawl workers (default 8)")
    ...
    ap_run.add_argument("--crawl-workers", type=int, default=8, help="Concurrent crawl workers (default 8)")
    ap_run.add_argument("--lighthouse-workers", type=int, default=2, help="Concurrent Lighthouse workers (default 2)")
